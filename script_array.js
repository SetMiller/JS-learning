...
// 📣 Аргументы => 1. функция, 2. начальное значение для функции 🔥🔥🔥
...
// 📣 Метод reduce() обрабатывает массив слева направо, метод reduceRight() обрабатывает массив справа налево
 ...
 // эта функция принимает два объекта и возвращает другой объект.
    ...
    let merjed = objects.reduce(union);           //👈 возвращает {x: 1, y: 2, z: 3}
...
// второго аргумента, т.е. методы reduce() и reduceRigth() могут дать разные результаты при использовании функции union()
    ...
    let leftMerjed = objects2.reduce(union);                      //👈 возвращает {x: 1🔥, a: 3🔥, y: 2, z: 3🔥}
    let rightMerjed = objects2.reduceRight(union);                //👈 возвращает {z: 3🔥, a: 1🔥, y: 2, x: 1🔥}
...
// 📣 Метод indexOf() обрабатывает массив слева направо, метод lastIndexOf() обрабатывает массив справа налево
    ...
    let leftIndex = ar.indexOf(30);                               //👈 возвращает 2
    let rigthIndex = ar.lastIndexOf(30);                          //👈 возвращает 4
    let noneIndex = ar.indexOf(50);                               //👈 возвращает -1, т.к. искомый элемент отсутствует в массиве.
