...
// 📣 Аргументы функции => 1. Аккумулятор значений; 2. текущий обрабатываемый элемент массива; 
// 3. индекс текущего обрабатываемого элемента массива(необязательный); 4 массив, для которого была вызвана функция reduce. 
