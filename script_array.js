...
//1️⃣ Добавление элементов в конец массива при помощи метода push(). Побочный эффект 🔥🔥🔥 возвращает длину массива 🔥🔥🔥
//2️⃣ Удаление элементов с конца массива при помощи метода pop(). Побочный эффект 🔥🔥🔥 возвращает значение удаленного элемента 🔥🔥🔥
...
//3️⃣ Добавление элементов в начало массива при помощи метода unshift(). Побочный эффект 🔥🔥🔥 возвращает длину массива 🔥🔥🔥
//4️⃣ Удаление элементов с начала массива при помощи метода shift(). Побочный эффект 🔥🔥🔥 возвращает значение удаленного элемента 🔥🔥🔥
...
//6️⃣ Удаление элементов при помощи изменения значения свойства length/ Побочный эффект 🔥🔥🔥 возвращает значение желаемой длины массива🔥🔥🔥
